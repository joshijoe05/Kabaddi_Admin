...
class SignUpReferee1 extends StatefulWidget {
  const SignUpReferee1({super.key});

  @override
  State<SignUpReferee1> createState() => _SignUpReferee1State();
}

class _SignUpReferee1State extends State<SignUpReferee1> {
